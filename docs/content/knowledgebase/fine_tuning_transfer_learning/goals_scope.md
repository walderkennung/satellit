...
This documentation adapts `facebook/sam3` (used via `Sam3Model` and `Sam3Processor` in `with_sam/src/satellit_sam/sam3.py`) to satellite and orthophoto forest segmentation (tree crowns, canopy regions, optional species classes).
