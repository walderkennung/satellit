...
from ..prompts import load_weak_label_bboxes, parse_bbox_prompts
    ...
    if weak_labels_csv is not None:
        try:
            ...
            raise typer.BadParameter(
                str(err), param_hint="--weak-labels-csv"
            ) from err

    if (
        normalized_text_prompt is None
        and not parsed_bbox_prompts
        and not weak_label_bboxes_by_tile
    ):
