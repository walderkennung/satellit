...
- Use the repository root Pixi project for non-SAM work, and use `with_sam`'s Pixi project for SAM work.
...
- This repository currently has a `pixi.toml` workspace without predefined tasks.
